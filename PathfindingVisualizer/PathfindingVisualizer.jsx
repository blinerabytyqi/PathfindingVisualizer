...
export default class PathfindingVisualizer extends Component {
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Loading" });
  ...
  animateDijkstra(visitedNodesInOrder, nodesInShortestPathOrder) {
    for (let i = 1; i <= visitedNodesInOrder.length; i++) {
      ...
      if (i === visitedNodesInOrder.length) {
        setTimeout(() => {
          this.setState({ topMessage: "Shortest Path Found" });
  ...
  render() {
    ...
    if (topMessage === "Shortest Path Found") {
      button_task = (
        <h2
          className="btn"
          href="#"
        ...
        >
          Reset <br/>
          The shortest path contains : {distanceToBeTraveled} blocks
          
       
        </h2>
      );
    } else if (topMessage === "Loading") {
    ...
    let textBox = (
      <div className="textBox">
        ...
        <div className="startPointContainer">
          <label htmlFor="point">Start Node :</label>
          <input
            type="number"
            name="point"
            id="start_row"
        ...
        <div className="endPointContainer">
          <label htmlFor="point">Target Node :</label>
          <input
            type="number"
            name="point"
            id="end_row"
    ...
    if (topMessage === "Loading") {
      textBox = null;
    } else if (topMessage === "Shortest Path Found") {
      textBox = (
        <div
      ...
      <div className="pathfindingVisualizer">
        <div className="container">
          <div className="heading">
            <h2 onClick={showPopUp}>Pathfinding Visualizer</h2>
            <h2>{topMessage}</h2>
          </div>
