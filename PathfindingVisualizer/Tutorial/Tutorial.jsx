    ...
    return (
      <div className="PopUpTextBox">
        <header>
          ...
          <p id="firstp">Quick Walkthrough to Dijkstra pathfinding visualizer</p>
        ...
        <div className="PopUpIntroductionText">
          ...
          <div className="player">
            ...
            <label htmlFor="end">Target : </label>
            ...
            <div style={{backgroundColor: ' rgba(204,191,179,0.75)'}} name="wall"></div>
